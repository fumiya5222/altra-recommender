...
const shoes = [
    {
        ...
        gender: 'M',
        category: { en: 'Snow / Wet', ja: '防水・スノー' },
...
function renderResult(shoe) {
    let catEmoji = shoe.category['en'].includes('Road') ? '🛣️ ' : shoe.category['en'].includes('Trail') ? '🏔️ ' : '❄️ ';
